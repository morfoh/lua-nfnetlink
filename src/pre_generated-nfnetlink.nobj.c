...
#define obj_type_nfnl_handle_check(L, _index) \
	obj_udata_luacheck(L, _index, &(obj_type_nfnl_handle))
#define obj_type_nfnl_handle_optional(L, _index) \
	obj_udata_luaoptional(L, _index, &(obj_type_nfnl_handle))
#define obj_type_nfnl_handle_delete(L, _index, flags) \
	obj_udata_luadelete_weak(L, _index, &(obj_type_nfnl_handle), flags)
...
static const char *nfnetlink_ffi_lua_code[] = { "local ffi=require\"ffi\"\n"
...
"\n"
"\n"
"local obj_type_nfnl_handle_check\n"
"local obj_type_nfnl_handle_delete\n"
"local obj_type_nfnl_handle_push\n"
"\n"
"do\n"
"	local obj_mt, obj_type, obj_ctype = obj_register_ctype(\"nfnl_handle\", \"nfnl_handle *\")\n"
"\n"
"	function obj_type_nfnl_handle_check(ptr)\n"
...
"		local bcaster = _obj_subs.nfnl_handle[ctype]\n"
"		if bcaster then\n"
"			return bcaster(ptr)\n"
"		end\n"
"		return error(\"Expected 'nfnl_handle *'\", 2)\n"
"	end\n"
"\n"
"	function obj_type_nfnl_handle_delete(ptr)\n"
...
"	end\n"
"\n"
"	function obj_type_nfnl_handle_push(ptr, flags)\n"
"		local id = obj_ptr_to_id(ptr)\n"
"		-- check weak refs\n"
...
"		return sformat(\"nfnl_handle: %p, flags=%d\", self, nobj_obj_flags[obj_ptr_to_id(self)] or 0)\n"
"	end\n"
"\n"
"	-- type checking function for C API.\n"
"	_priv[obj_type] = obj_type_nfnl_handle_check\n"
"	-- push function for C API.\n"
"	reg_table[obj_type] = function(ptr, flags)\n"
"		return obj_type_nfnl_handle_push(ffi.cast(obj_ctype,ptr), flags)\n"
"	end\n"
"\n"
"	-- export check functions for use in other modules.\n"
"	obj_mt.c_check = obj_type_nfnl_handle_check\n"
"	obj_mt.ffi_check = obj_type_nfnl_handle_check\n"
"end\n"
"\n"
"\n"
...
"\n"
"	-- export check functions for use in other modules.\n"
"	obj_mt.c_check = obj_type_nlif_handle_check\n"
"	obj_mt.ffi_check = obj_type_nlif_handle_check\n"
"end\n"
"\n"
"\n"
...
"\n"
"C = ffi_load(\"nfnetlink\",false)\n"
"\n"
"\n"
"-- Start \"nfnl_handle\" FFI interface\n"
"-- method: new\n"
"function _pub.nfnl_handle.new()\n"
"  local this_flags = OBJ_UDATA_FLAG_OWN\n"
"  local self\n"
"  self = C.nfnl_open()\n"
"  return obj_type_nfnl_handle_push(self, this_flags)\n"
"end\n"
"register_default_constructor(_pub,\"nfnl_handle\",_pub.nfnl_handle.new)\n"
"\n"
"-- method: close\n"
"function _meth.nfnl_handle.close(self)\n"
"  local self,this_flags = obj_type_nfnl_handle_delete(self)\n"
"  if not self then return end\n"
"  local rc_nfnl_close = 0\n"
"  rc_nfnl_close = C.nfnl_close(self)\n"
"  return rc_nfnl_close\n"
"end\n"
"_priv.nfnl_handle.__gc = _meth.nfnl_handle.close\n"
"\n"
...
"  \n"
"  local rc_nlif_query = 0\n"
"  rc_nlif_query = C.nlif_query(self)\n"
"  return rc_nlif_query\n"
"end\n"
"\n"
...
/* method: new */
static int nfnl_handle__new__meth(lua_State *L) {
  int this_flags = OBJ_UDATA_FLAG_OWN;
  nfnl_handle * this;
  this = nfnl_open();
  obj_type_nfnl_handle_push(L, this, this_flags);
  return 1;
}

/* method: close */
static int nfnl_handle__close__meth(lua_State *L) {
  int this_flags = 0;
  nfnl_handle * this;
  int rc_nfnl_close = 0;
  this = obj_type_nfnl_handle_delete(L,1,&(this_flags));
...
/* method: query */
static int nlif_handle__query__meth(lua_State *L) {
  nlif_handle * this;
  int rc_nlif_query = 0;
  this = obj_type_nlif_handle_check(L,1);
  rc_nlif_query = nlif_query(this);
  lua_pushinteger(L, rc_nlif_query);
  return 1;
}
...
static const luaL_reg obj_nfnl_handle_pub_funcs[] = {
  {"new", nfnl_handle__new__meth},
  {NULL, NULL}
};

static const luaL_reg obj_nfnl_handle_methods[] = {
  {"close", nfnl_handle__close__meth},
  {NULL, NULL}
};

static const luaL_reg obj_nfnl_handle_metas[] = {
  {"__gc", nfnl_handle__close__meth},
  {"__tostring", obj_udata_default_tostring},
  {"__eq", obj_udata_default_equal},
  {NULL, NULL}
};

static const obj_base obj_nfnl_handle_bases[] = {
  {-1, NULL}
};

static const obj_field obj_nfnl_handle_fields[] = {
  {NULL, 0, 0, 0}
};

static const obj_const obj_nfnl_handle_constants[] = {
  {NULL, NULL, 0.0 , 0}
};

static const reg_impl obj_nfnl_handle_implements[] = {
  {NULL, NULL}
};
...
static const obj_const nfnetlink_constants[] = {
  {NULL, NULL, 0.0 , 0}
};
...
#if LUAJIT_FFI
static const ffi_export_symbol nfnetlink_ffi_export[] = {
  {NULL, { NULL } }
};
#endif
...
LUA_NOBJ_API int luaopen_nfnetlink(lua_State *L) {
	...
	luaL_register(L, "nfnetlink", nfnetlink_function);
#else
	lua_newtable(L);
	luaL_register(L, NULL, nfnetlink_function);
#endif

	/* register module constants. */
	obj_type_register_constants(L, nfnetlink_constants, -1, 0);
	...
	if(nobj_check_ffi_support(L)) {
		nobj_try_loading_ffi(L, "nfnetlink.nobj.ffi.lua", nfnetlink_ffi_lua_code,
			nfnetlink_ffi_export, priv_table);
	}
#endif
